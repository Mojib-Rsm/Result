        ...
        <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
            ...
            <Card className="shadow-lg">
                ...
                <CardContent className="p-6 md:p-8 prose dark:prose-invert max-w-none">
                    <p>
                        BD Edu Hub ওয়েবসাইটের সমস্ত তথ্য শুধুমাত্র সাধারণ তথ্যের উদ্দেশ্যে সরবরাহ করা হয়েছে। আমরা এই তথ্যের সম্পূর্ণতা, নির্ভুলতা, নির্ভরযোগ্যতা, উপযুক্ততা বা প্রাপ্যতার বিষয়ে কোনো ওয়ারেন্টি বা গ্যারান্টি প্রদান করি না।
                    </p>
                    ...
                    <p>
                        এই সাইটটি ব্যবহার করার মাধ্যমে, আপনি আমাদের দাবিত্যাগের শর্তাবলীতে সম্মত হচ্ছেন।
                    </p>
                </CardContent>
            </Card>
        </div>
