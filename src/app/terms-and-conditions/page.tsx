        ...
        <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
            ...
            <Card className="shadow-lg">
                ...
                <CardContent className="p-6 md:p-8 prose dark:prose-invert max-w-none">
                    ...
                    <h2>৩. SMS পরিষেবা</h2>
                    <p>
                        আমাদের SMS অ্যালার্ট পরিষেবাটি একটি স্বয়ংক্রিয় সিস্টেমের মাধ্যমে পরিচালিত হয়। আমরা ফলাফল প্রকাশের সাথে সাথে SMS পাঠানোর চেষ্টা করি, তবে প্রযুক্তিগত কারণে доставিতে বিলম্ব বা ব্যর্থতার জন্য আমরা দায়ী থাকব না।
                    </p>
